...
import { buildHazardResponse } from '@/services/hazardForecastService';
...
export async function GET(request: Request) {
  ...
  return withAuthenticatedLatestForecast(request, forecast => ({
    window_minutes: minutes,
    ...buildHazardResponse(forecast, minutes),
  }));
}
